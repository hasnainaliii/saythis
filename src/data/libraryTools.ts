...
export const LIBRARY_TOOLS: LibraryTool[] = [
  ...
  { id: "gentle-onset", name: "Gentle Onset Practice", summary: "Ease into vowels and words.", description: "Gentle onset reduces hard starts by softening voice onset and airflow.", steps: ["Take a slow breath.", "Start with an easy vowel.", "Blend into the full word."], category: "drills", difficulty: "beginner", durationMinutes: 8, iconKey: "gentleOnset", heroImage: HERO_IMAGES.drills, relatedToolIds: ["prolonged-speech"], isLocked: false, completedToday: true },
  { id: "prolonged-speech", name: "Prolonged Speech Stretcher", summary: "Stretch sounds for control.", description: "Prolonged speech slows rate and improves control across phrases.", steps: ["Stretch each vowel slightly.", "Keep airflow steady.", "Shorten gradually as control improves."], category: "drills", difficulty: "intermediate", durationMinutes: 12, iconKey: "prolonged", heroImage: HERO_IMAGES.drills, relatedToolIds: ["gentle-onset"], isLocked: false, completedToday: false },

  { id: "stutter-tap-counter", name: "Stutter Tap Counter", summary: "Track moments with a quick tap.", description: "Tapping helps you capture stutter moments and build awareness over time.", steps: ["Tap once for each stutter.", "Review the count after a session.", "Note triggers and patterns."], category: "biofeedback", difficulty: "beginner", durationMinutes: 6, iconKey: "tapCounter", heroImage: HERO_IMAGES.biofeedback, relatedToolIds: ["timed-reading-wpm"], isLocked: false, completedToday: false },
  { id: "timed-reading-wpm", name: "Timed Reading WPM", summary: "Measure your reading speed.", description: "Timed reading builds awareness of pace and how it affects fluency.", steps: ["Read a short passage.", "Check words per minute.", "Repeat at a slower target pace."], category: "biofeedback", difficulty: "beginner", durationMinutes: 8, iconKey: "wpm", heroImage: HERO_IMAGES.biofeedback, relatedToolIds: ["stutter-tap-counter"], isLocked: false, completedToday: false },

  { id: "virtual-coffee-order", name: "Virtual Coffee Order", summary: "Practice a short scripted order.", description: "Simulated ordering builds confidence with structured speech and pacing.", steps: ["Read the sample order.", "Speak it aloud with pacing.", "Repeat with your own words."], category: "simulation", difficulty: "beginner", durationMinutes: 8, iconKey: "coffee", heroImage: HERO_IMAGES.simulation, relatedToolIds: ["phone-call-simulator"], isLocked: false, completedToday: false },
  { id: "phone-call-simulator", name: "Phone Call Simulator", summary: "Rehearse calls without pressure.", description: "Simulated calls reduce anxiety and help you stay fluent on the phone.", steps: ["Choose a call scenario.", "Use a slow, steady pace.", "Replay and refine your response."], category: "simulation", difficulty: "intermediate", durationMinutes: 10, iconKey: "phoneSim", heroImage: HERO_IMAGES.simulation, relatedToolIds: ["virtual-coffee-order"], isLocked: true, completedToday: false },
];
