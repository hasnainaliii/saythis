...
export const LAST_USED_TOOL_ID = "box_breathing";
...
export const LIBRARY_TOOLS: LibraryTool[] = [
  ...
  { id: "box_breathing", name: "Box Breathing", summary: "Calm your system in four counts.", description: "Box breathing steadies the nervous system to reduce tension before speech.", steps: ["Inhale for four counts.", "Hold for four counts.", "Exhale for four counts, then hold again."], category: "breathing", difficulty: "beginner", durationMinutes: 5, iconKey: "boxBreathing", heroImage: require("../assets/images/tools/box-breathing.png"), relatedToolIds: ["diaphragmatic_breathing"], isLocked: false, completedToday: true, isRecommended: true },
  { id: "diaphragmatic_breathing", name: "Diaphragmatic Breathing", summary: "Breathe low and steady.", description: "Deep belly breathing supports smoother airflow and calmer speech starts.", steps: ["Place a hand on your belly.", "Inhale and feel the belly rise.", "Speak a short phrase on a slow exhale."], category: "breathing", difficulty: "beginner", durationMinutes: 6, iconKey: "diaphragmatic", heroImage: require("../assets/images/tools/diaphragmatic-breathing.png"), relatedToolIds: ["box_breathing", "pre_speech_routine"], isLocked: false, completedToday: false },
  { id: "pre_speech_routine", name: "Pre-Speech Routine", summary: "Warm up your breath and voice.", description: "A short routine prepares airflow, posture, and focus before speaking tasks.", steps: ["Do two cycles of slow breathing.", "Hum lightly to relax the voice.", "Start with a gentle onset phrase."], category: "breathing", difficulty: "beginner", durationMinutes: 7, iconKey: "routine", heroImage: require("../assets/images/tools/pre-speech-routine.png"), relatedToolIds: ["diaphragmatic_breathing"], isLocked: false, completedToday: false },

  { id: "gentle_onset", name: "Gentle Onset Practice", summary: "Ease into vowels and words.", description: "Gentle onset reduces hard starts by softening voice onset and airflow.", steps: ["Take a slow breath.", "Start with an easy vowel.", "Blend into the full word."], category: "drills", difficulty: "beginner", durationMinutes: 8, iconKey: "gentleOnset", heroImage: require("../assets/images/tools/gentle-onset.png"), relatedToolIds: ["prolonged_speech"], isLocked: false, completedToday: true },
  { id: "prolonged_speech", name: "Prolonged Speech Stretcher", summary: "Stretch sounds for control.", description: "Prolonged speech slows rate and improves control across phrases.", steps: ["Stretch each vowel slightly.", "Keep airflow steady.", "Shorten gradually as control improves."], category: "drills", difficulty: "intermediate", durationMinutes: 12, iconKey: "prolonged", heroImage: require("../assets/images/tools/prolonged-speech.png"), relatedToolIds: ["gentle_onset"], isLocked: false, completedToday: false },

  { id: "stutter_tap_counter", name: "Stutter Tap Counter", summary: "Track moments with a quick tap.", description: "Tapping helps you capture stutter moments and build awareness over time.", steps: ["Tap once for each stutter.", "Review the count after a session.", "Note triggers and patterns."], category: "biofeedback", difficulty: "beginner", durationMinutes: 6, iconKey: "tapCounter", heroImage: require("../assets/images/tools/stutter-tap-counter.png"), relatedToolIds: ["timed_reading_wpm"], isLocked: false, completedToday: false },
  { id: "timed_reading_wpm", name: "Timed Reading WPM", summary: "Measure your reading speed.", description: "Timed reading builds awareness of pace and how it affects fluency.", steps: ["Read a short passage.", "Check words per minute.", "Repeat at a slower target pace."], category: "biofeedback", difficulty: "beginner", durationMinutes: 8, iconKey: "wpm", heroImage: require("../assets/images/tools/timed-reading-wpm.png"), relatedToolIds: ["stutter_tap_counter"], isLocked: false, completedToday: false },

  { id: "virtual_coffee_order", name: "Virtual Coffee Order", summary: "Practice a short scripted order.", description: "Simulated ordering builds confidence with structured speech and pacing.", steps: ["Read the sample order.", "Speak it aloud with pacing.", "Repeat with your own words."], category: "simulation", difficulty: "beginner", durationMinutes: 8, iconKey: "coffee", heroImage: require("../assets/images/tools/virtual-coffee-order.png"), relatedToolIds: ["phone_call_simulator"], isLocked: false, completedToday: false },
  { id: "phone_call_simulator", name: "Phone Call Simulator", summary: "Rehearse calls without pressure.", description: "Simulated calls reduce anxiety and help you stay fluent on the phone.", steps: ["Choose a call scenario.", "Use a slow, steady pace.", "Replay and refine your response."], category: "simulation", difficulty: "intermediate", durationMinutes: 10, iconKey: "phoneSim", heroImage: require("../assets/images/tools/phone-call-simulator.png"), relatedToolIds: ["virtual_coffee_order"], isLocked: true, completedToday: false },
];
